      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/projects"
              className="flex items-center gap-2 px-4 py-2 text-gray-900 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colors"
            >
              <FolderOpen className="w-5 h-5" />
              <span className="hidden sm:inline font-medium">My Projects</span>
            </Link>
          </div>
        </div>
      </header>
